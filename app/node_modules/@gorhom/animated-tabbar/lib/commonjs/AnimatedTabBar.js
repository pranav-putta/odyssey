...
function AnimatedTabBar(props) {
  ...
  const {
    ...
    safeAreaInsets: overrideSafeAreaInsets
        ...
        rest = _objectWithoutProperties(props, ["tabs", "state", "navigation", "descriptors", "onTabPress", "onTabLongPress", "style", "safeAreaInsets"]); //#region styles
  ...
  }), [overrideStyle, safeBottomArea]); //#endregion
  //#region variables
  ...
  return /*#__PURE__*/_react.default.createElement(_AnimatedTabBarView.AnimatedTabBarView, _extends({
    index: navigationIndex,
