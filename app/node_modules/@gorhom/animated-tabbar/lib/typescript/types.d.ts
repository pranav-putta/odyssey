...
export declare type TabsConfig<T, P = {
    [key: string]: T;
}> = {
    [key in keyof P]: T;
};
...
export declare type TabBarViewProps<C, T> = {
    /**
...
} & TabBarConfigurableProps & C;
export interface TabBarItemProps extends Required<Omit<TabBarConfigurableProps, 'onLongPress' | 'duration' | 'easing'>> {
    /**
...
export declare type AnimatedTabBarProps<T extends PresetEnum = 'bubble'> = {
    /**
     * Animation preset.
     */
    preset?: T;
...
} & Omit<TabBarConfigurableProps, 'onLongPress'> & ExtractPresetConfig<T>;
export declare type AnimatedTabBarViewProps<T extends PresetEnum> = {
    /**
     * Initial index.
     */
    index: number;
...
} & TabBarConfigurableProps & ExtractPresetConfig<T>;
export declare type ExtractPresetConfig<T extends PresetEnum> = {
